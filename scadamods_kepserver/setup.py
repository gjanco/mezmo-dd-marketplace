...
# Get version info
ABOUT = {}
with open(path.join(HERE, "datadog_checks", "scadamods_kepserver", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name="datadog-scadamods_kepserver",
    version=ABOUT["__version__"],
    description="The kepserver check",
    long_description=long_description,
    long_description_content_type="text/markdown",
    keywords="datadog agent scadamods_kepserver check",
    # Author details
    author="scadamods",
    author_email="support@scadamods.com",
    # License
    ...
    packages=["datadog_checks.scadamods_kepserver"],
