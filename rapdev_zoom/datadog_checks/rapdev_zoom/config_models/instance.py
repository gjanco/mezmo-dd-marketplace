...
class InstanceConfig(BaseModel):
    ...
    base_api_url: str
    collect_accounts: Optional[bool]
    collect_im_metrics: Optional[bool]
    collect_meeting_host: Optional[bool]
    collect_participant_details: Optional[bool]
    collect_plan_usage: Optional[bool]
    collect_top_25_issues: Optional[bool]
    ...
    users_to_track: Optional[Sequence[str]]
