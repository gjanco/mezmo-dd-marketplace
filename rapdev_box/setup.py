...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'rapdev_box', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-rapdev_box',
    version=ABOUT['__version__'],
    description='The Box check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent rapdev_box check',
    # Author details
    author='RapDev',
    ...
    packages=['datadog_checks.rapdev_box'],
