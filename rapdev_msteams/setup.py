...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'rapdev_msteams', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-rapdev_msteams',
    version=ABOUT['__version__'],
    description='Microsoft Teams Call Quality integration',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent rapdev microsoft teams check',
    # Author details
    author='RapDev',
    ...
    packages=['datadog_checks.rapdev_msteams'],
