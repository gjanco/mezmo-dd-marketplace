...
class InstanceConfig(BaseModel):
    ...
    expire_window: Optional[float] = Field(None, ge=60.0)
    ...
    msgraph_baseurl: Optional[str]
    notifications_baseurl: Optional[str]
    ntlm_domain: Optional[str]
    password: Optional[str]
    persist_connections: Optional[bool]
    proxy: Optional[Proxy]
    read_timeout: Optional[float]
    renewal_window: Optional[float] = Field(None, ge=30.0)
