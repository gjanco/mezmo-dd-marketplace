...
def instance_expire_window(field, value):
    return 180
...
def instance_msgraph_baseurl(field, value):
    return 'https://graph.microsoft.com'


def instance_notifications_baseurl(field, value):
    return 'https://msgraph-subscriptions-notifications.synth-rapdev.io'
...
def instance_renewal_window(field, value):
    return 90
