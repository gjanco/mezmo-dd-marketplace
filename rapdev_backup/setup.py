...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'rapdev_backup', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-rapdev_backup',
    version=ABOUT['__version__'],
    description='Backup Integration',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='RapDev agent Datadog backup check',
    ...
    packages=['datadog_checks.rapdev_backup'],
