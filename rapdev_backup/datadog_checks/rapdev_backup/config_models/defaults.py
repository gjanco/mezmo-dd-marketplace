...
def instance_assume_role_arn(field, value):
    return 'arn:aws:iam::ACCOUNT-ID-WITHOUT-HYPHENS:role/MyTestRole123'


def instance_assume_role_external_id(field, value):
    return get_default_field_value(field, value)


def instance_assume_session_name(field, value):
    return 'DatadogBackupSession'
...
def instance_aws_access_key(field, value):
    return get_default_field_value(field, value)
...
def instance_azure_connection_string(field, value):
    return get_default_field_value(field, value)


def instance_azure_container_name(field, value):
    return get_default_field_value(field, value)
...
def instance_timestamp_format(field, value):
    return '%Y-%m-%dT%H%M%S'
