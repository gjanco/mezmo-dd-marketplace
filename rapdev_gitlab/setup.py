...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'rapdev_gitlab', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-rapdev_gitlab',
    version=ABOUT['__version__'],
    description='The rapdev_gitlab check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent rapdev_gitlab check',
    ...
    packages=['datadog_checks.rapdev_gitlab'],
