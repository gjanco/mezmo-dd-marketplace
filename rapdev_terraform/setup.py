...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'rapdev_terraform', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-rapdev_terraform',
    version=ABOUT['__version__'],
    description='Terraform integration',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='rapdev datadog agent terraform check',
    # Author details
    author='RapDev',
    ...
    packages=['datadog_checks.rapdev_terraform'],
