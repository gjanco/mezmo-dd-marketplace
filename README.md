...
| unit_label | The label that will display in the "Pricing" section of your Marketplace tile. | string | Only Required for "tag_count" billing type | Example: "Price per [unit_label] per month". |
