...
[Learn More](https://insights.docs.fairwinds.com/technical-details/self-hosted/installation/)
 
### Jira frontend
You can now create tickets in Jira. Use the "Create Tickets" button at the top of the Action Items table.
[Learn More](https://insights.docs.fairwinds.com/run/agent/action-items/#ticketing-integrations)
 
...
[Learn More](https://insights.docs.fairwinds.com/run/agent/cluster-summary/)
...
### Automation Rules UI
We are happy to introduce The Automation Rules UI! Insights provides over 100 checks for Kubernetes clusters and resources. These checks are increasingly run in a variety of contexts, such as CI/CD, admission control, and in-cluster. Some checks may be more appropriate in specific contexts, require a higher level of severity, or trigger different alert/response mechanisms. Rules allow users to modify existing action items within Insights and customize how they see fit. Find the Automation Rules under Automation in the navigation bar.
...
[Learn More](https://insights.docs.fairwinds.com/configure/policy/rules/)
...
[Learn More](https://insights.docs.fairwinds.com/configure/policy/policy/)
...
[Learn More](https://insights.docs.fairwinds.com/configure/reports/resource-metrics/)
...
[Learn More](https://insights.docs.fairwinds.com/run/agent/report-hub/)
...
You can now create and run custom checks in Rego (OPA's policy language) to create Action Items in Fairwinds Insights. To get started, visit our docs to [learn how to add Rego policies to Fairwinds Insights](https://insights.docs.fairwinds.com/configure/policy/policy/#create-a-policy).
...
Check out [insights.fairwinds.com/auth/register](https://insights.fairwinds.com/auth/register) to see our new registration flow.
...
### Weekly email digest
Users can now receive a weekly email digest for new Action Items found by Fairwinds Insights. These email alerts will not include specific information about findings; for that, users will need to login to Fairwinds Insights. A user can subscribe and unsubscribe from email notifications by clicking their username in the upper-right corner of the screen, or 'Unsubscribe' from the email itself.
