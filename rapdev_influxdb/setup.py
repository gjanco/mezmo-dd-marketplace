...
# Get version info
ABOUT = {}
with open(path.join(HERE, "datadog_checks", "rapdev_influxdb", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name="datadog-rapdev_influxdb",
    version=ABOUT["__version__"],
    description="The InfluxDB check",
    long_description=long_description,
    long_description_content_type="text/markdown",
    keywords="datadog agent rapdev_influxdb check",
    ...
    packages=["datadog_checks.rapdev_influxdb"],
