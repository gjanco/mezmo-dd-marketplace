...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'rapdev_github', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-rapdev_github',
    version=ABOUT['__version__'],
    description='The rapdev_github check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent rapdev_github check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Henri Hatch',
    author_email='henri.hatch@rapdev.io',
    # License
    ...
    packages=['datadog_checks.rapdev_github'],
