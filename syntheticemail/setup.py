...
# Get version info
ABOUT = {}
with open(path.join(HERE, "datadog_checks", "syntheticemail", "__about__.py")) as f:
    exec(f.read(), ABOUT)
...
setup(
    name="datadog-syntheticemail",
    version=ABOUT["__version__"],
    description="Multi-regional synthetic email delivery Datadog agent integration",
    long_description=long_description,
    long_description_content_type="text/markdown",
    keywords="rapdev datadog agent synthetic email check",
    ...
    packages=["datadog_checks.syntheticemail"],
