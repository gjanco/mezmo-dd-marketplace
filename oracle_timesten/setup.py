...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'oracle_timesten', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='rapdev oracle timesten datadog agent oracle_timesten check',
    ...
    packages=['datadog_checks.oracle_timesten'],
