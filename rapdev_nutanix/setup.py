...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'rapdev_nutanix', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-rapdev_nutanix',
    version=ABOUT['__version__'],
    description='Nutanix Integration',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='RapDev agent Nutanix check',
    # Author details
    author='RapDev',
    ...
    packages=['datadog_checks.rapdev_nutanix'],
