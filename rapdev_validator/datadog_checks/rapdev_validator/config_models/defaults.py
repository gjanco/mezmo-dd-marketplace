...
def instance_hosts_to_ignore(field, value):
    return get_default_field_value(field, value)


def instance_ignore_paas(field, value):
    return False
...
def instance_required_tags(field, value):
    return get_default_field_value(field, value)
...
def instance_validate_hosts(field, value):
    return True
