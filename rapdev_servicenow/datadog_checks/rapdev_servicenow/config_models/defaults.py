...
def instance_collect_itsm_metrics(field, value):
    return False


def instance_collect_statsdo(field, value):
    return True
...
def instance_incident_closed_states(field, value):
    return get_default_field_value(field, value)


def instance_incident_open_states(field, value):
    return get_default_field_value(field, value)
...
def instance_opt_fields(field, value):
    return get_default_field_value(field, value)
...
def instance_statsdo_auth(field, value):
    return False
